...
type SymbolPositionSnapshot struct {
	...
	EntryLevel float64                  `json:"entryLevel"`
	StopLoss   float64                  `json:"stop_loss"`
	EntryTime  int64                    `json:"entry_time"` // 毫秒时间戳
	Spider     *decision.SpiderSnapshot `json:"spider"`
...
func SaveSnapshotOnOpen(baseDir, symbol, side string, entryLevel float64, stopLoss float64, entryTimeMillis int64, snap *decision.SpiderSnapshot) error {
	symbol = strings.ToUpper(symbol)
