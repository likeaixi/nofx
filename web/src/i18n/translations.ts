...
export const translations = {
  en: {
    ...
    faqDatabaseLockedAnswer:
      'Stop all OctoTrader processes with "docker compose down" or "pkill OctoTrader", then restart with "docker compose up -d".',
  ...
  zh: {
    ...
    step1Desc:
      'git clone https://github.com/OctoTrader/octotrader 并切换到 dev 分支测试新功能。',
    step2Title: '配置环境',
    step2Desc:
    ...
    faqDatabaseLockedAnswer:
      '使用 "docker compose down" 或 "pkill OctoTrader" 停止所有 OctoTrader 进程，然后使用 "docker compose up -d" 重启。',
